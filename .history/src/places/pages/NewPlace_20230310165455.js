...
const NewPlace = () => {
  ...
  const placeSubmitHandler = async (event) => {
    ...
    try {
      ...
      formData.append("title", formState.inputs.email.value);
      formData.append("description", formState.inputs.name.value);
      formData.append("address", formState.inputs.password.value);
